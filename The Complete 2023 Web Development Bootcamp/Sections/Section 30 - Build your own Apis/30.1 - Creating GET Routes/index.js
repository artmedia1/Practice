...
app.get("/jokes/:id", (req, res) => {
  ...
  const foundJoke = jokes.find((joke) => joke.id === id); //Search jokes for joke (Note: joke can be named anything), such that jokes.id === id.
  //const foundJoke = jokes.find((anything) => anything.id === id);
  res.json(foundJoke);
});
